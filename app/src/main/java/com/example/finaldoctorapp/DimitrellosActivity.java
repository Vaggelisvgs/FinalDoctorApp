...
public class DimitrellosActivity extends AppCompatActivity {

    //This Class is About doctor  Dimitrellos
    ...
    private final String doctorCategory="ΠΝΕΥΜΟΝΟΛΟΓΟΣ";
    ...
    private void updateCloseDate(String newClosedDate) {
        ...
        doctorRef.push().setValue(newClosedDate)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(DimitrellosActivity.this, "Successfully add the new appointment of user.", Toast.LENGTH_SHORT).show();
                })
