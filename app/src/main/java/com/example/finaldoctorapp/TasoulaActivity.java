...
public class TasoulaActivity extends AppCompatActivity {

    //This Class is About doctor Tasoula
    ...
    private final String classID="ΤΑΣΟΥΛΑ ΧΑΡΑ";
    ...
    private void updateCloseDate(String newClosedDate) {
        ...
        doctorRef.push().setValue(newClosedDate)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(TasoulaActivity.this, "Successfully add the new appointment of user.", Toast.LENGTH_SHORT).show();
                })
