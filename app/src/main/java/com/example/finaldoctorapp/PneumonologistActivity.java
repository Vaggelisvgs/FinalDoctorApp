...
public class PneumonologistActivity extends AppCompatActivity {

    //This Class is About Pneumonologists doctors
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pneumonologist);
    ...
    public void openSiouziosActivity(View view) {
    ...
    public void openDimitrellosActivity(View view) {
