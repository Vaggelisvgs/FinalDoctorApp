...
public class OtolaryngologistActivity extends AppCompatActivity {
    //This Class is About Otolaryngologist doctors
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otolaryngologist);
    ...
    public void openRozakiActivity(View view) {
    ...
    public void openNikolaidisActivity(View view) {
