...
public class InternistActivity extends AppCompatActivity {

    //This Class is About Internist doctors
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internist);
    ...
    public void openRigakisGActivity(View view) {
    ...
    public void openSakellarActivity(View view) {
